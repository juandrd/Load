 ...
 */
@Embeddable
public class PagosBodegaPK implements Serializable {
    ...
    public PagosBodegaPK() {
    }

    public PagosBodegaPK(int pacienteKey, int demografiaPacienteKey, long fechaKey, int empresaKey, int preexistenciaKey) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PagosBodegaPK)) {
            return false;
        }
        PagosBodegaPK other = (PagosBodegaPK) object;
    ...
    public String toString() {
        return "Entidades_Bodega.PagosBodegaPK[ pacienteKey=" + pacienteKey + ", demografiaPacienteKey=" + demografiaPacienteKey + ", fechaKey=" + fechaKey + ", empresaKey=" + empresaKey + ", preexistenciaKey=" + preexistenciaKey + " ]";
    }
